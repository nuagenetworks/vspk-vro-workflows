 1. To install the Advanced Workflows package:
   ...
   a. Log in to the vRO client.
   b. In the Orchestrator Client main window, select "Design" mode.
   c. Click on the "Import package..." icon.
   d. Select the package file and click the "Open" button.
